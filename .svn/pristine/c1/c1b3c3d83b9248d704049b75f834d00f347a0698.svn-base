...
NSString *const jsVertexShaderString = SHADER_STRING
(
...
NSString *const jsRgbFragmentShaderString = SHADER_STRING
(
...
NSString *const jsYuvFragmentShaderString = SHADER_STRING
(
 varying highp vec2 v_texcoord;
...
@protocol JSCourseVideoGLRenderer
- (BOOL) isValid;
...
@interface JSCourseVideoGLRenderer_RGB : NSObject<JSCourseVideoGLRenderer> {
...
@implementation JSCourseVideoGLRenderer_RGB
...
- (NSString *) fragmentShader
{
    return jsRgbFragmentShaderString;
}
...
@interface JSCourseVideoGLRenderer_YUV : NSObject<JSCourseVideoGLRenderer> {
...
@implementation JSCourseVideoGLRenderer_YUV
...
- (NSString *) fragmentShader
{
    return jsYuvFragmentShaderString;
}
...
@implementation JSCourseVideoGLView {
    ...
    id<JSCourseVideoGLRenderer> _renderer;
}
             ...
             decoder: (KxMovieDecoder *) decoder
{
    ...
    if (self) {
        ...
        if ([decoder setupVideoFrameFormat:KxVideoFrameFormatYUV]) {
            ...
            _renderer = [[JSCourseVideoGLRenderer_YUV alloc] init];
            LoggerVideo(1, @"OK use YUV GL renderer");
            
        } else {
            
            _renderer = [[JSCourseVideoGLRenderer_RGB alloc] init];
...
- (BOOL)loadShaders
{
    ...
    vertShader = compileShader(GL_VERTEX_SHADER, jsVertexShaderString);
    if (!vertShader)
        goto exit;
