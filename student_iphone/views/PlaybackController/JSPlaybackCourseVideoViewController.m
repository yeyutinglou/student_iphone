//
//  JSPlaybackCourseVideoViewController.m
//  kxmovieapp
//
...
#import "JSCourseVideoGLView.h"
#import "KxLogger.h"

NSString * const JsPlaybackCourseVideoParameterMinBufferedDuration = @"JsPlaybackCourseVideoParameterMinBufferedDuration";
NSString * const JsPlaybackCourseVideoParameterMaxBufferedDuration = @"JsPlaybackCourseVideoParameterMaxBufferedDuration";
NSString * const JsPlaybackCourseVideoParameterDisableDeinterlacing = @"JsPlaybackCourseVideoParameterDisableDeinterlacing";
...
@interface JSPlaybackCourseVideoViewController ()
{
...
@implementation JSPlaybackCourseVideoViewController
                             ...
                             audioEnabled:(BOOL)audioEnabled
{
    ...
    JSPlaybackCourseVideoViewController *vc = [[JSPlaybackCourseVideoViewController alloc] initWithContentPath: path parameters: parameters audioEnabled:audioEnabled];
    return vc;
}
            ...
            audioEnabled:(BOOL)audioEnabled
{
    ...
    if (self) {
        ...
        __weak JSPlaybackCourseVideoViewController *weakSelf = self;
        
        KxMovieDecoder *decoder = [[KxMovieDecoder alloc] init];
        
        decoder.interruptCallback = ^BOOL(){
            
            __strong JSPlaybackCourseVideoViewController *strongSelf = weakSelf;
...
- (void) handleTap: (UITapGestureRecognizer *) sender
{
    if (sender.state == UIGestureRecognizerStateEnded) {
        ...
        if (sender == _tapGestureRecognizer) {
            ...
            {
                [self.delegete exchangeVideoCourseware:YES];
            }
               ...
               withError: (NSError *) error
{
    ...
    if (!error && decoder) {
        ...
        if (_parameters.count) {
            ...
            val = [_parameters valueForKey: JsPlaybackCourseVideoParameterMinBufferedDuration];
            if ([val isKindOfClass:[NSNumber class]])
                _minBufferedDuration = [val floatValue];
            
            val = [_parameters valueForKey: JsPlaybackCourseVideoParameterMaxBufferedDuration];
            if ([val isKindOfClass:[NSNumber class]])
                _maxBufferedDuration = [val floatValue];
            
            val = [_parameters valueForKey: JsPlaybackCourseVideoParameterDisableDeinterlacing];
            if ([val isKindOfClass:[NSNumber class]])
...
- (void) setupPresentView
{
    ...
    if (_decoder.validVideo) {
        _glView = [[JSCourseVideoGLView alloc] initWithFrame:bounds decoder:_decoder];
    }
...
- (void) updateHUD
{
    ...
    {
        [self.delegete updateTopHud:position duration:duration type:@"coursevideo"];
    }
